...
import { GraduationCap, LayoutDashboard, FileText, Database, BarChart, Settings, HelpCircle, LogOut } from "lucide-react";
      ...
      <div className="flex h-screen w-full bg-[#0a0d14] text-gray-100 font-sans overflow-hidden">
        ...
        <aside className="w-64 border-r border-white/5 flex flex-col bg-[#111520] shrink-0">
          ...
          <div className="p-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg leading-tight tracking-tight text-white">AeroExam Pro</h1>
